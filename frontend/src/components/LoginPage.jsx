...
const LoginPage = () => {
  ...
  const handleLogin = async (e) => {
    ...
    setError("");
    try {
      const response = await axios.post("http://localhost:3060/api/auth/login", { email, password });
      ...
      setError(error.response ? error.response.data.msg : "An error occurred. Please try again.");
    }
  };
  // const handleLogin = async (e) => {
  //   e.preventDefault();
