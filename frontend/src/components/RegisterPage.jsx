...
const RegisterPage = () => {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      const response = await axios.post("http://localhost:3060/api/auth/register", {
        // phone,
        email,
        password,
        firstName,
    ...
    <div className='min-h-screen bg-gray-100 flex justify-center items-center'>
      <div className='w-full max-w-lg p-8 space-y-6 bg-white rounded-lg shadow-md mt-10 mb-10'>
        ...
        <form onSubmit={handleRegister} className='space-y-4'>
          ...
          {/* Sign up button */}
          <div>
            <button type='submit' className='w-full bg-orange-500 text-white font-semibold py-2 px-4 rounded hover:bg-orange-600'>
              SIGN UP
            </button>
          </div>
        </form>
