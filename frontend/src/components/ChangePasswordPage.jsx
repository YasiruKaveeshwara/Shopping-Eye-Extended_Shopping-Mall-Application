...
const ChangePasswordPage = () => {
  ...
  const handleChangePassword = async (e) => {
    ...
    try {
      ...
      await axios.put(
        "http://localhost:3060/api/auth/changePassword", // Updated endpoint
      ...
      <div className='flex-grow bg-gray-100 p-8'>
        <div className='w-full max-w-md p-8 space-y-6 bg-white rounded-lg shadow-md mx-auto'>
          <div className='flex items-center mb-6'>
            <button onClick={handleGoBack} className='text-blue-500 hover:text-blue-700 focus:outline-none'>
              <HiArrowLeft size={24} />
            </button>
            <h2 className='text-2xl font-bold text-center flex-grow'>Change Password</h2>
          </div>
