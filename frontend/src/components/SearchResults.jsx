...
const SearchResults = () => {
  ...
  useEffect(() => {
    const fetchResults = async () => {
      try {
        const response = await axios.get(`http://localhost:3060/api/search?query=${query}`);
  ...
  return (
    <div className='flex'>
      ...
      <div className='w-1/6 pl-16 pt-10 border-r'>{/* <h3 className="font-semibold mb-2">Search Results</h3> */}</div>
